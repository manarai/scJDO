"""
scqdiff/pipeline/train_hybrid_grn.py
======================================
...
3. Train latent drift on z (standard scQDiff training).
...
from scqdiff.models.representation import RepresentationModel, build_representation
from scqdiff.models.hybrid_grn import HybridGRNConfig, HybridGRNModel, HybridGRNResult
from scqdiff.io.anndata_hybrid import tensors_from_anndata_hybrid, compute_bin_means
...
def train_latent_drift(
    ...
    This is a thin wrapper around the standard scQDiff drift training,
