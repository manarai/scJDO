...
and exposes a clean API that mirrors the existing scQDiff style.
...
from scqdiff.grn.pullback import (
...
class HybridGRNConfig:
    ...
    ----------
    drift_cfg :
        Configuration for the latent DriftField (existing scQDiff config).
    rep_cfg :
...
class HybridGRNModel(nn.Module):
    """HybridGRN: opt-in experimental extension for scQDiff.
    ...
    _EXPERIMENTAL_WARNING = (
        "[HybridGRN] This is an experimental extension of scQDiff. "
    ...
    def forward_latent(
        ...
        This is identical to the standard scQDiff workflow.
