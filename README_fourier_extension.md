...
## Quick Enable
1. Drop the `scjdo/Fourier/` folder and the new files into your repo root.
...
```python
from scjdo.Fourier.transforms import dft, idft
from scjdo.Fourier.kspace_samplers import KSpaceEulerMaruyama
...
```python
from scjdo.transport.spectral_bridge import spectral_precondition_marginals
