...
scJDO can be used with any `AnnData` object that contains a suitable expression matrix and either a grouping variable for root-based DPT estimation or a precomputed pseudotime variable.
